...
void CAN_FIFORelease(CAN_Group group, uint8_t fifo_num);
uint8_t CAN_MessagePending(CAN_Group group, uint8_t fifo_num);


/* Operation modes functions **************************************************/
uint8_t CAN_OperatingModeRequest(CAN_Group group, uint8_t mode);
...
void CAN_ClearITPendingBit(CAN_Group group, uint32_t it);
#endif /* _STM32F10X_CAN_H_ */